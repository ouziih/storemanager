...
CREATE TABLE dettes (
    ...
    statut          TEXT NOT NULL DEFAULT 'NON_SOLDEE' CHECK (statut IN ('NON_SOLDEE', 'PARTIELLEMENT_SOLDEE', 'SOLDEE'))
);
...
CREATE TABLE approvisionnements (
    ...
    date_reception  TEXT,
    statut          TEXT NOT NULL DEFAULT 'EN_COURS' CHECK (statut IN ('EN_COURS', 'RECU', 'PARTIEL'))
);
